...
`pip install git+https://github.com/biomodels/BIOMD0000000393.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000393.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000393 as model`
...
**Note:** Model of the Calvin cycle and the related end-product pathways to starch and sucrose synthesis and photorespiration by Zhu et al. (2007, [DOI:10.1104/pp.107.103713](http://dx.doi.org/10.1104/pp.107.103713) ) and the personally provided implementation. 

The parameter values are partly taken from Pettersson and Ryde-Pettersson
(1988, [DOI:10.1111/j.1432-1033.1988.tb14242.x](http://dx.doi.org/10.1111/j.14
32-1033.1988.tb14242.x) ). The initial metabolite values are chosen from the
